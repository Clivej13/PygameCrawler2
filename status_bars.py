...
class StatusBars:
    def __init__(self, player):
        ...
        if hasattr(player, 'portrait_image_path'):
            try:
                self.portrait_image = pygame.image.load(player.portrait_image_path).convert_alpha()
            except pygame.error as e:
                print(f"Error loading portrait image {player.portrait_image_path}: {e}")
